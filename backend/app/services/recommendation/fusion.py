...
class FusionEngine:
    ...
    def fuse(self, cf_scores, swing_scores, graph_scores, semantic_scores, hot_scores=None, top_n=20, weights=None):
        """
        加权线性融合多路得分
        ...
        all_candidates = set(cf_scores) | set(swing_scores) | set(graph_scores) | set(semantic_scores) | set(hot_scores)
    ...
    def fuse_with_details(self, cf_scores, swing_scores, graph_scores, semantic_scores, hot_scores=None, top_n=20, weights=None):
